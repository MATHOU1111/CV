...
const Navbar = () => {
    ...
    return (
        <Flex as="nav" align="center" justify="space-between" wrap="wrap" padding="1.2rem" bg={useColorModeValue('gray.100', 'gray.900')} color={useColorModeValue('gray.600', 'white')} className="shadow-lg rounded-lg">
            <Flex className="flex flex-wrap justify-center gap-2 ml-2">
                <a
                    href="https://www.linkedin.com/in/mathisdumage/"
                    className="bg-stone-800 p-2 font-semibold text-white inline-flex items-center rounded-full">
                    <svg
            ...
            <Flex marginRight="8">
                ...
                <Button as={Link} to="/contact" marginRight="2" >
                    Contact
                </Button>
