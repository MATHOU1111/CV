...
import { Flex, Box, Text, IconButton, useColorMode, useColorModeValue, Stack, Collapse, useDisclosure, Button } from '@chakra-ui/react';
    ...
    return (
        <Flex as="nav" align="center" justify="space-between" wrap="wrap" padding="1.2rem" bg={useColorModeValue('gray.100', 'gray.900')} color={useColorModeValue('gray.600', 'white')} className="shadow-lg rounded-lg">
            <div className="flex flex-wrap justify-center gap-2">
                ...
                <Button onClick={toggleColorMode} variant="ghost" color="white" mr="8">
                    {colorMode === 'dark' ? (
                        <SunIcon boxSize={4} />
                    ) : (
                        <MoonIcon boxSize={4} />
